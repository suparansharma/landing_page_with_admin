...
<head>
    ...
    <title>ইলিশ আচার - স্বাদ কি জানো</title>
    <style>
...
<body>
    ...
    <div class="header-section">
        <div class="header-title">ইলিশ আচার - স্বাদ কি জানো</div>
        <div class="header-subtitle">ইলিশ মাছের টুকরো দিয়ে বানানো আচার, খেতে দারুণ স্বাদ, খিচুড়ি বা গরম ভাতের সাথে খেতে দারুণ লাগে</div>
        
        <div>
            <a href="#checkout" class="btn-order">অর্ডার দিন</a>
            <a href="tel:01854-472049" class="btn-order">📞 01854-472049</a>
        </div>
        
        <div class="header-image-container">
            <!-- Assuming user's first image is 1.png -->
    ...
    <div class="main-content">
        ...
        <div class="product-card">
            ...
            <div class="premium-text">প্রিমিয়াম কোয়ালিটি - স্বাদে গন্ধে অতুলনীয়</div>
            <div class="weight-text">২০০ গ্রাম ইলিশ মাছের আচার</div>
            
            <div class="price-strike"><span>৪৫০ টাকা</span></div>
            <div class="price-current">ইলিশের আচার - ৩৫০ টাকা</div>
            
            <div class="delivery-text">ডেলিভারি চার্জ ১০০ টাকা যোগ হবে</div>
            
            <div class="guarantee-box">বাংলাদেশের সেরা কোয়ালিটি এবং সেরা মূল্য গ্যারান্টি ।</div>
        </div>
    ...
    <div class="alert-section">
        ...
        <div class="alert-text">যেকোনো জিজ্ঞাসায় কল করুন বা হোয়াটসঅ্যাপ করুন: +8801854-472049</div>
    </div>
            ...
            <div class="checkout-right">
                ...
                <form action="#" method="POST">
                    ...
                    <div class="order-summary">
                        ...
                        <div class="summary-row">
                            <span style="color: #28a745;">ইলিশ মাছের আচার (২০০ গ্রাম) x 1</span>
                            <span style="color: #28a745;">৳ ৩৫০</span>
                        </div>
                        <div class="summary-row">
                            <span>Subtotal</span>
                            <span>৳ ৩৫০</span>
